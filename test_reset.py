...
# Generate token
token_cmd = f"""cd ~/web/oracle/oracle-ics-backend && node -e 'const j=require("jsonwebtoken");console.log(j.sign({{sub:{TOKEN_USER_ID},email:"minhtuan90959095@gmail.com"}},"***REMOVED-JWT***",{{expiresIn:"2h"}}));'"""
